  ...
  theme: {
    extend: {
      ...
      backgroundImage: (theme) => ({
        ...
        'virtual_small': "linear-gradient(rgba(0,0,0,0.3),rgba(0,0,0,0.3)),url('../src/assets/virtual_small.png')",
        'birthday_small': "linear-gradient(rgba(0,0,0,0.3),rgba(0,0,0,0.3)),url('../src/assets/birthday_small.png')",
        'maternity_small': "linear-gradient(rgba(0,0,0,0.3),rgba(0,0,0,0.3)),url('../src/assets/maternity_small.png')",
      }),
    },
  },
  plugins: [],
