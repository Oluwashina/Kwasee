        ...
        <>
           <div className=''>
                ...
                <div className='bg-[#725C5C] text-center py-4 md:py-6'>
                    <h6 className='text-white text-lg md:text-2xl font-della tracking-wide font-medium'>Maternity Shoot </h6>
                </div>
                    ...
                    <div className='md:px-10 px-4'>
                      <p className='text-[#262220] opacity-[.75] md:text-center font-della mt-2 tracking-wide'>$106/PER LOOK</p>
                        <div className='md:text-center font-raleway'>
                            <h6 className='text-[#000000] text-base font-della tracking-wide mt-6 leading-6'>MATERNITY SHOOT:</h6>
