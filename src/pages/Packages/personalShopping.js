        ...
        <>
          <div className=''>
                <div className='relative h-[400px] overflow-hidden md:h-[800px] flex'>
                    ...
                    <div>
                     <h5 className='hidden md:block text-[#FFFFFF] text-center absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 font-semibold text-2xl md:text-3xl mt-2 max-w-lg leading-[140%] tracking-wide'>
